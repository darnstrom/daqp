...
sense2(ms+1:end)=8*S;
[x_daqp_plain,fval_x_daqp, flag_daqp_plain, info_daqp_plain] =  daqpmex_quadprog(Hsoft',fsoft,[Asoft_upper;Asoft_lower]',[ub;bupper;1e9*ones(m,1)],[lb;-1e9*ones(m,1);blower],[],[],sense,daqp_opts);

[x_daqp,fval_x_daqp, flag_daqp, info_daqp] =  daqpmex_quadprog(H',f,A',[ub;bupper],[lb;blower],[],[],sense2,daqp_opts);
