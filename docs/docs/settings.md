...
| `eps_prox` | Requested regularization for proximal-point iterations. For a numerically singular dense Hessian, DAQP may raise this to a scale-aware stability floor. | 1e-6|
